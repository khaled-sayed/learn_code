...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="course-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        @if($course->photo)
                            <img class="course-image" src="/courses/{{$course->photo->filename}}">
                        @else
                            <img src="/courses/1.jpg" class="course-image">
                        @endif
                    </div>
        ...
        <div class="enroll-form">
            ...
            @else
{{--                <button class="btn btn-default btn-enroll" id="enroll"  name="enroll">Enroll</button>--}}
