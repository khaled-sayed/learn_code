                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="status" class="custom-select" id="status" required>
                                        <option value="0" @if ($course->status == 0)
                                            selected
                                        @endif>FREE</option>
                                ...
                                <div class="form-group{{ $errors->has('track') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="track_id" class="custom-select" id="track" required>
                                        @foreach (\App\Track::all() as $track)
                                        <option @if ($course->track_id == $track->id)
                                            selected
                                        @endif value="{{$track->id}}">{{$track->name}}</option>
                                        @endforeach
                                    </select>
