	...
	<div class="famous-courses">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="course">
					@if($course->photo)
					<a href="/courses/{{$course->slug}}"><img src="/courses/{{ $course->photo->filename }}"></a>
					@else
					<a href="/courses/{{$course->slug}}"><img src="/courses/1.jpg"></a>
					@endif
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="course-image">
										@if($course->photo)
										<img src="/courses/{{ $course->photo->filename }}">
										@else
										<img src="/courses/1.jpg">
										@endif
									</div>
								</div>
								<div class="col-sm">
